package com.algorithmlx.algolib.config;
...
public class ModConfig {
    ...
    public ModConfig(Class className, String name) {
    ...
    private void setup() {
        final File configDir = new File(FabricLoader.getInstance().getConfigDir().toFile(), name);
